...
//	}  
	...
	public static SpannableStringBuilder spanSearchContent(String keyword, String text, int color) {
		...
		while (matcher.find()) {
			...
			spannable.setSpan(styleSpan, matcher.start(), matcher.end(), Spannable.SPAN_MARK_MARK);
			spannable.setSpan(span, matcher.start(), matcher.end(), Spannable.SPAN_MARK_MARK);
		}
		return spannable;
	}

	public static SpannableStringBuilder spanSearchContentFirst(String keyword, String text, int color) {
		SpannableStringBuilder spannable = new SpannableStringBuilder(text);
		CharacterStyle span;
		String regex = "(?i)" + keyword;
		Pattern pattern = Pattern.compile(regex);
